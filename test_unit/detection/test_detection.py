...
class TestDetection(TestCase):
    def setUp(self):
        ...
        self.path_im2 = os.path.join(os.pardir, 'AIVA-Madera_Sergio_Mireya/test_unit/data/st1012')
        self.path_im1_out = os.path.join(os.pardir, 'AIVA-Madera_Sergio_Mireya/test_unit/data/st1526_split.jpg')
        self.path_im2_out = os.path.join(os.pardir, 'AIVA-Madera_Sergio_Mireya/test_unit/data/st1012_split.jpg')
